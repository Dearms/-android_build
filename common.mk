...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/rootdir/etc/thermald_h.conf:system/etc/thermald_h.conf
    $(COMMON_PATH)/rootdir/etc/thermald_l.conf:system/etc/thermald_l.conf
